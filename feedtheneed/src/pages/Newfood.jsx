...
const Newfood = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const { userid, caption, image, selectedType, quantity, selectedCity, contactNumber } = formData;
    //"Hello folks! We have non-veg for 20 people in Chrompet, so grab it fast!"
    ...
    try {
      ...
      setFormData({
        ...
        quantity: 1,
        selectedCity: null,
        contactNumber: '+91', // Reset contact number to +91 after submission
      });
      setPreviewImage(null);
    } catch (error) {
